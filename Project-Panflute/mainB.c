...
interrupt void WDT_interval_handler()
{
	...
	if(Max1.magnitude > PLAY_THRESHOLD)
	{
		switch(Max1.index)
		{
			case 0:
			{
				change_tone_volume_output0(_C5, 50);
				break;
			}
			case 1:
			{
				change_tone_volume_output0(_B4, 50);
				break;
			}
			case 2:
			{
			...
			case 3:
			{
				change_tone_volume_output0(_A4, 50);
				break;
			}
			case 4:
			{
				change_tone_volume_output0(_G4, 50);
				break;
			}
			default:
			{
	...
	else
	{
		...
		if(Max2.magnitude > PLAY_THRESHOLD)
		{
			switch(Max2.index)
			{
				case 0:
				{
					change_tone_volume_output1(_C5, 50);
					break;
				}
				case 1:
				{
					change_tone_volume_output1(_B4, 50);
					break;
				}
				case 2:
				{
				...
				case 3:
				{
					change_tone_volume_output1(_A4, 50);
					break;
				}
				case 4:
				{
					change_tone_volume_output1(_G4, 50);
					break;
				}
				default:
				{
